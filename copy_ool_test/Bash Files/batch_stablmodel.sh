...
python run_regression_cv.py \
    --features_path /home/groups/gbrice/ptb-drugscreen/ool_stabl/onset_test/ina_13OG_final_long_allstims_filtered.csv \
    --results_dir /home/groups/gbrice/ptb-drugscreen/ool_stabl/onset_test/run_stabl_XGB_KO_ptb_data \
