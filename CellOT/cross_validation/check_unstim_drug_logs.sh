...
JOB_LIST="/home/groups/gbrice/ptb-drugscreen/ot/cellot/datasets/ptb_concatenated_per_condition_celltype/job_list_all_drugs.txt"
...
while IFS=',' read -r stim sanitized_celltype original_celltype; do
    #((i++))
    OUTDIR="${RESULTS_BASE}/${stim}/${sanitized_celltype}/model-Unstim_${sanitized_celltype}" #${stim}
