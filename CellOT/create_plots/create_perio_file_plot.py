        ...
        for stim in stims:
            for cell in CELL_TYPES:
                ...
                if stim == "P. gingivalis":
                    ...
                    stim_folder = stim
                pred_path = f"/home/groups/gbrice/ptb-drugscreen/ot/cellot/datasets/perio_on_surge_train_corrected_simple/perio_data_sherlock_{stim_folder}_{cell}.h5ad"
                if not os.path.exists(pred_path):
                    raise AssertionError(f"Missing prediction file: {pred_path}")

                df_all = load_anndata_to_df(pred_path)
                #print(ad.read(pred_path).obs)
